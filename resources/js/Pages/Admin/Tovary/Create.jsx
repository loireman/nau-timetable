        ...
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-4 text-gray-300">
            ...
            <form className="px-4 py-8" onSubmit={submit}>
              ...
              <InputLabel htmlFor="property1" value="Властивість 1" />
              <TextInput
                id="property1"
                name="property1"
                ...
                autoComplete="off"
                isFocused={false}
                onChange={(e) => setData("property1", e.target.value)}
                required
              />
              <InputError message={errors.property1} className="mt-2" />

              <InputLabel htmlFor="property2" value="Властивість 2" />
              <TextInput
                id="property2"
                name="property2"
                ...
                autoComplete="off"
                isFocused={false}
                onChange={(e) => setData("property2", e.target.value)}
                required
              />
              <InputError message={errors.property2} className="mt-2" />
