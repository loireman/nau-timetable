...
export default function Index({ auth, orders, can }) {
                    ...
                    <div className="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg mb-3 p-3 grid md:flex gap-3">
                        ...
                        <Dropdown>
                            ...
                            <Dropdown.Content>
                                ...
                                >
                                    Дата прибуття (за зростанням)
                                </Dropdown.Link>
                                <Dropdown.Link
                                    onClick={() => handleSort("-arrival")}
                                >
                                    Дата прибуття (за спаданням)
                                </Dropdown.Link>
                            </Dropdown.Content>
                        </Dropdown>
                    </div>
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <table className="w-full text-gray-900 dark:text-gray-100">
                            <thead>
                                ...
                                <td className="hidden sm:table-cell p-3 border-b border-gray-300">
                                    Клієнт
                                </td>
                                <td className="hidden md:table-cell p-3 border-b border-gray-300">
                                    Прибуде
                                </td>
                                {(can.edit || can.delete) && (
                                    <td className="p-3 border-b border-gray-300">
                        ...
                        <Pagination pageContent={orders}></Pagination>
                    </div>
                </div>
            </div>
        </AuthenticatedLayout>
