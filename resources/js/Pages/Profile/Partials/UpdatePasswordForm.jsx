...
export default function UpdatePasswordForm({ className = '' }) {
    ...
    return (
        <section className={className}>
            <header>
                <h2 className="text-lg font-medium text-gray-900">Оновити пароль</h2>

                <p className="mt-1 text-sm text-gray-600">
                Переконайтеся, що ваш обліковий запис використовує довгий випадковий пароль для захисту.
                </p>
            </header>
            ...
            <form onSubmit={updatePassword} className="mt-6 space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    >
                        <p className="text-sm text-gray-600 dark:text-gray-400">Збережено.</p>
                    </Transition>
                </div>
            </form>
        </section>
